...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="header-slider normal-slider">
                        <div class="header-slider-item">
                            <img src="../assets/img/desli3.jpg" alt="Slider Image" />
                        ...
                        <div class="header-slider-item">
                            <img src="../assets/img/desli1.jpg" alt="Slider Image" />
                            <div class="header-slider-caption">
                ...
                <div class="col-md-3">
                    <div class="header-img">
                        <div class="img-item">
                            <img src="../assets/img/feature-1.jpg" />
                            <a class="img-text" href="">
                                <p>Haz de tu cuerpo un templo</p>
                            </a>
                        </div>
                        <div class="img-item">
                            <img src="../assets/img/feature-2.jpg" />
                            <a class="img-text" href="">
                                <p>Esfuerzate para conseguir tu proposito</p>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-6 feature-col">
                    <div class="feature-content">
                        ...
                        <h2>Devoluciones Aseguradas</h2>
                        <p>
                            Si no estas satisfecho con tu compra haz una devolucion
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 feature-col">
                    <div class="feature-content">
                        ...
                        <h2>Servicio 24/7</h2>
                        <p>
                            Estaremos atentos a cualquier queja o sujerencia
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3">
                    <div class="category-item ch-400">
                        ...
                        <a class="category-name" href="">
                            <p>Debemos poner algo interesante</p>
                        </a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="category-item ch-250">
                        <img src="../assets/img/feature-3.jpg" />
                        <a class="category-name" href="">
    ...
    <div class="call-to-action">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1>Llama si tienes alguna inquietud</h1>
                </div>
                <div class="col-md-6">
                    <a href="tel:0123456789">+57 313 554 5365</a>
                </div>
            </div>
        </div>
    </div>
