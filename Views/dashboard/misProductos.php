...
if (!isset($_SESSION['documento'])) {
    ...
    require "../../Controllers/php/users/productos.php";
    $producto = new Producto();
    $respMisPublicaciones = $producto->GetMisPublicaciones();
?>
    <!DOCTYPE html>
    <html lang="en">
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                <h6 class="mb-4">Mis Productos</h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php foreach ($respMisPublicaciones as $data) { ?>
                                                <tr>
