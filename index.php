...
?>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0">Bienvenidos a MAKEMAKE</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="pre-wrap masthead-subheading font-weight-light mb-0">En este sitio encontrarás productos Gamer del tipo que necesites </p>
            </div>
        </header>
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Categorias</h2>
                </div>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading d-inline-block text-white">Desarrolladores</h2>
                </div>
                <!-- Icon Divider-->
                <div class="divider-custom divider-light">
                    <div class="divider-custom-line"></div>
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto">
                        <p class="pre-wrap lead">-Brayam Stiven Castaño Duque.
-Pedro  José Bustos Saldaña.</p>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <div class="lead font-weight-bold">(313) 554-5563</div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="d-flex flex-column align-items-center">
                            <div class="icon-contact mb-3"><i class="far fa-envelope"></i></div>
                            <div class="text-muted">Email</div><a class="lead font-weight-bold" href="mailto:makemake@gmail.com">makemake@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
